...
module genreColorMatching
    ...
    genre_colors_by_our_results = Dict(
        ...
        genre_colors_by_our_results_with_percent = Dict(
        "Action"    => ["orange", "red", "light_blue"], 
        "Adventure" => ["orange", "light_blue", "red"],
        "Animation" => ["orange", "light_blue", "red"],
        "Children"  => ["orange", "light_blue", "red"],
        "Comedy"    => ["orange", "red", "light_blue"],
        "Crime"     => ["orange","red","light_blue"],
        "Documentary" => ["orange","red","light_blue"],
        "Drama"     => ["orange","red","light_blue"],
        "Fantasy"   => ["orange","red","black"],
        "Film-Noir" => ["yellow","orange","red"],
        "Horror"    => ["red","orange","black"],
        "IMAX"      => ["light_blue","yellow", "blue"],
        "Musical"   => ["red","orange","yellow"],
        "Mystery"   => ["red","orange","yellow"],
        "Romance"   => ["orange","red","light_blue"],
        "Sci-fi"    => ["light_blue","red","orange"],
        "Thriller"  => ["red","orange","light_blue"],
        "War"       => ["orange","red","yellow"],
        "Western"   => ["orange","red","yellow"]
    )
